    ...
    return (
        <main className="bg-purple-50 min-h-screen px-5 pb-5">
            <header className="flex items-center gap-2 pt-10">
                <div className="flex justify-center items-center w-16 h-16 bg-gradient-to-r from-[rgb(129,179,228)] to-[rgb(119,115,255)]  rounded-[100%] bg-amber-50">
            ...
            <section className='px-3 py-3 mt-10 bg-white rounded-lg shadow-lg h-auto]'>
                ...
                <div className='grid grid-cols-2 gap-3 mt-4'>
                    ...
                    <div className='rounded-md flex justify-center h-20 bg-gradient-to-r from-[rgb(119,115,255)] to-[rgb(129,179,228)]'>
                    ...
                    <div className='rounded-md flex justify-center h-20 bg-gradient-to-r from-[rgb(129,179,228)] to-[rgb(119,115,255)]'>
